...
# gun_data = pd.read_excel('Gun_fct_multipliers.xlsx')
gun_data = pd.read_excel('Gun_fct_base.xlsx')

attachment_dict = {}

# gun_data = gun_data[gun_data["gun_name"].isin(['KG M40'])]

# gun_data = gun_data[gun_data['source_game'].isin(['iw8'])]
...
with open('combo_Gun_fct_base.json','w') as f:
